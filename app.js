...
class FakeIos {
    ...
    drawTime(time) {
        ...
        this.CoreDraw.drawText(time, 'Bold 24px "PingFang"', '#fff', { x: (this.CoreDraw.getWidth() - width) / 2 - 0.6, y: 4 - 0.6 })
    }
    ...
    drawNickName(text) {
        this.CoreDraw.ctx.font = 'normal 30px "PingFang"'
        var width = this.CoreDraw.ctx.measureText(text).width
        this.CoreDraw.drawText(text, 'normal 38px "PingFang"', '#fff',
            {
